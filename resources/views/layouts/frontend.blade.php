        ...
        <div class="border-bottom border-info">
            ...
            {{--<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">--}}
                ...
                {{--<div class="carousel-inner" role="listbox">--}}
                    {{--<div class="carousel-item active m-bg-slide">--}}
                        {{--<img class="d-block img-fluid m-slide" src="slide/slide1.jpg" alt="First slide"/>--}}
                        {{--<div class="carousel-caption d-none d-md-block">--}}
                            {{--<h3>slide 1</h3>--}}
                            {{--<p>slide 1</p>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="carousel-item m-bg-slide">--}}
                        {{--<img class="d-block img-fluid m-slide" src="slide/slide2.jpg" alt="Second slide"/>--}}
                        {{--<div class="carousel-caption d-none d-md-block">--}}
                            {{--<h3>slide 2</h3>--}}
                            {{--<p>slide 2</p>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="carousel-item m-bg-slide">--}}
                        {{--<img class="d-block img-fluid m-slide" src="slide/slide3.jpg" alt="Third slide"/>--}}
                        {{--<div class="carousel-caption d-none d-md-block">--}}
                            {{--<h3>slide 3</h3>--}}
                            {{--<p>slide 3</p>--}}
                        {{--</div>--}}

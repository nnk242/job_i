        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link active m-tab-i" id="nav-home-tab" href="{{url('/')}}"
               ...
               aria-controls="nav-home" aria-selected="true"><span class="fa fa-bell-o text-danger"></span>&nbsp;Ảnh
                mới</a>
            <a class="nav-item nav-link m-tab-i" id="nav-profile-tab" href="{{route('group')}}"
               role="tab"
                                        ...
                                        <div class="border border-info float-left m-border-darius-5">
                                            <div class="grid">
                                                @foreach($group->image as $image)
                                                    <div class="w-50 float-left grid-item">
                                                        <img class="m-collection-w m-border-darius-5" src="{{in_array(substr($image->url, 0, 4), $first_url_image)?$image->url:asset($image->url)}}">
                                                    </div>
                                                @endforeach
                                            </div>

                        ...
                        @if(isset($groups))
                                @if (count($groups))
                                    ...
                                    <div class="text-center mb-3 mt-2">
                                        <a href="{{route('tagPost', ['id' => $tag_old])}}"><button class="btn btn-secondary"><i class="fa fa-plus-square-o"></i> Xem thêm</button></a>
                                    </div>
                                @else
                            ...
                            @if(isset($images))
                                @if (count($images))
                                    ...
                                    <div class="text-center mb-3">
                                        <a href="{{route('tagImage', ['id' => $tag_old])}}"><button class="btn btn-secondary"><i class="fa fa-plus-square-o"></i> Xem thêm</button></a>
                                    </div>
                                @else
                                    @include('frontends.includes.notfounds.not_item')
                                @endif
